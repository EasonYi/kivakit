...
{
    public static final PackagePath TELENAV = parsePackagePath(Listener.deafListener(), "com.telenav");
    ...
    {
        return packagePath(type, parseStringPath(Listener.deafListener(), type.getName(), null, "\\.").withoutLast());
    }
