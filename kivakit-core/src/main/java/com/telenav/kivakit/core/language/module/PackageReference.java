...
{
    public static final PackageReference TELENAV = parsePackageReference(Listener.deafListener(), "com.telenav");
    ...
    {
        return packageReference(type, parseStringPath(Listener.deafListener(), type.getName(), null, "\\.").withoutLast());
    }
